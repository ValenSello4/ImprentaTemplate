export const accentStyles = {
  cyan: {
    ...
    button: 'bg-amber-800 hover:bg-amber-700 text-white-950 border-transparent',
    secondary: 'border-amber-700 hover:text-white-950',
  ...
  emerald: {
    ...
    button: 'bg-emerald-800 hover:bg-emerald-700 text-white-950 border-transparent',
    secondary: 'border-emerald-700 hover:text-white-950',
  ...
  fuchsia: {
    ...
    button: 'bg-rose-800 hover:bg-rose-700 text-white-950 border-transparent',
    secondary: 'border-rose-700 hover:text-white-950',
