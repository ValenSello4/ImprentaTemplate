...
function NotFoundPage() {
  return (
    <div className="min-h-screen bg-[#f3e0c1] text-slate-950 flex items-center justify-center px-6 py-24">
      <div className="max-w-xl rounded-[2rem] border border-wood-panel bg-paper-surface p-12 text-center shadow-rustic">
        ...
        <p className="mt-4 text-lg text-slate-700">No se encontró el tenant solicitado.</p>
        <Link
          to="/"
